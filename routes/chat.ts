...
router.post("/:chat_id/should_review", checkIsAdmin, async (req, res) => {
  try {
...
router.post("/training", checkIsAdmin, async (req, res) => {
  try {
    const bot_id = req.body.bot_id || req.query.bot_id;
    if (!bot_id) {
...
router.post("/:chat_id/retry", checkIsAdmin, async (req, res) => {
  try {
    const { chat_id } = req.params;
...
router.post("/:chat_id/reviewed", async (req, res) => {
  const { chat_id } = req.params;
